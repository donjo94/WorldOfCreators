...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['mdp']) && strlen($_POST['mdp']) >= 6 && $_POST['mdp'] === $_POST['passwordvalid']) {
...
var_dump($data);
// die;
$req = $bdd->prepare('INSERT INTO users(firstname, lastname, pseudo, email, mdp) VALUES(:firstname, :lastname, :pseudo, :email, :mdp)');
$req->execute($data);
header('Location: ../index.php');
exit();
